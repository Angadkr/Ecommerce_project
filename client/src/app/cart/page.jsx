...
const CartPage = () => {
  ...
  const [shippingAddressGoogleMaps, setshippingAddressGoogleMaps] = useState("");
  ...
  const handleAddOrder = async () => {
    ...
    if (!shippingAddress || !shippingAddressGoogleMaps || !contactNumber) {
      Swal.fire({
        icon: 'error',
        title: 'Oops...',
    ...
    try {
      const orderData = {
        ...
        shippingAddressGoogleMaps:shippingAddressGoogleMaps,
...
{/* // se Studio */}
              ...
              />
                ...
                value={shippingAddressGoogleMaps}
                onChange={(e) => setshippingAddressGoogleMaps(e.target.value)}
                className="border border-gray-300 rounded-md p-2 mb-2 w-full"
              />
              <input
                type='number'
