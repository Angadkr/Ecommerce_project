...
const ProductPage = () => {
  ...
  const handleAddProduct = async () => {
    try {
      //we will use FormData() constructor why because it's easier to understand plus also it's default encType is multipart/form-data
      ...
      resetForm();
      //resetForm() function is used to reset the form
      Swal.fire({
        icon: 'success',
        title: 'Product Added!',
  ...
  const handleUpdateProduct = async () => {
    try {
      ...
      await dispatch(updateProduct({ productId: selectedProductId, productData: formData }));
      resetForm();
      Swal.fire({
        icon: 'success',
