"use client";
//use client is used to specify client component
import React, { useEffect, useState } from "react";
//require React.And  useEffect , useState react hooks .
import { useDispatch, useSelector } from "react-redux";
//require useDispatch , useSelector react-redux hooks
import { fetchCategories, addCategory, deleteCategory, updateCategory } from "../../reducers/categoryReducer";
//require our async thunks so that we can dispatch them and call for action to change our state
import Swal from "sweetalert2";
//require Swal for sweeralert2 alerts
//Swal.fire is the function that fires the alert and also we need to configure it.
...
const CategoryPage = () => {
  ...
  //agar state me categories nahi hai to matlab hame require karni padegi 
  useEffect(() => {
  ...
  const handleAddCategory = async () => {
    try {
      ...
      setName("");
      //setName null hora kyuki input lete hue hamne uss state ko bhara but add karne ke baad empty karne ki zarurat hai.
